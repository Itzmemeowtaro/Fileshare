...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002195629647 -1002257627668 -1002409501828').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002409501828"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002257627668"))
FORCE_SUB_CHANNEL3 = int(os.environ.get("FORCE_SUB_CHANNEL3", "-1002195629647"))
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<blockquote><b>{previouscaption}</b></blockquote> <blockquote><b>By : @Anime_Tomb\nNetwork : @YugenNetwork</b></blockquote>")
